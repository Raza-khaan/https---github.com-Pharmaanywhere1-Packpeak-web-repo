  ...
  <div class="container-fluid" style="margin:11% auto !Important">
      ...
      <!-- <div class="login-box-body"> -->
        ...
        <div class="text-center mb-4">
          <p class="login-box-msg text-center"><b>Change  Password</b></p>
        </div>
        <!-- <form action="{{ url('admin/passwords/email') }}" method="post"> -->

        <form  action="{{ url('admin/passwords/updatepasswords') }}" method="get">
        ...
        <div class="row" id="step1">
          <div class="form-group col-md-12">
            <input type="text"  value="{{$email}}" name="email" class="form-control @error('email') is-invalid @enderror  " placeholder="Email"/>
