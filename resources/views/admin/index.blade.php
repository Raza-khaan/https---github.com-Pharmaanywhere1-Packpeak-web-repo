            ...
            <div class="row">
                ...
                <div class="pharmici-info">
                  <div class="row">
                    <div class="col-6 col-md-7">
                      <span>{{$allPharmacyCount}}</span>
                      <p>Pharmacies</p>
                      <a href="{{url('admin/all_pharmacies')}}">More Info</a>
                    </div>
                    <div class="col-6 col-md-5 text-right">
                      <div class="store">
                        <img class="img-fluid" src="{{ URL::asset('admin/images/storefront.png')}}" alt="">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="pharmici-info">
                  <div class="row">
                    <div class="col-6 col-md-7">
                      <span>{{$allTechnicians}}</span>
                      <p>Assistants</p>
                      <!-- <p>Pharmacists Assistants</p> -->
                      <a href="{{url('admin/all_technician')}}">More Info</a>
                    </div>
                    <div class="col-6 col-md-5 text-right">
                      <div class="store assist">
                        <img class="img-fluid" src="{{ URL::asset('admin/images/assistant.png')}}" alt="">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="pharmici-info">
                  <div class="row">
                    <div class="col-6 col-md-7">
                      ...
                      <p>Patients</p>
                      <a href="{{url('admin/new_patients_report')}}">More Info</a>
                    </div>
                    <div class="col-6 col-md-5 text-right">
                      <div class="store patient">
                        <img class="img-fluid" src="{{ URL::asset('admin/images/patient.png')}}" alt="">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <tr> 
                    <td class="pharma-loc">
                      ...
                      <div class="pharmacy-name">
                        ...
                        <span id="dist_<?= $i; ?>"></span><span class="open-dot"></span><span class="open-til">Open 'til 6 pm</span>
                      </div>
                    </td>
                  </tr>
                  <?php
...
<script type="text/javascript">
  ...
  function initMap(address) {
    ...
    var locations= {!! json_encode($pharmacylist) !!};
