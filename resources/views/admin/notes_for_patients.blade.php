        ...
        <div class="row">
            ...
            <div class="col-md-6 m-auto">
                <div class="update-information">
                    <div class="notes">
                        <h3 class="text-center">Add Notes for patient</h3>
                        @if(Session::has('msg'))
                        {!! Session::get("msg") !!}
                        @endif
                        @if($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="company_name">Company Name <span class="text-danger"> *</span>
                                    </label> <span class="loader_company"></span>
                                ...
                                <div class="form-group col-md-12">
                                    <label for="patient_name">Patient Name <span class="text-danger">
                                            *</span></label>
                                    <select required class="form-control" name="patient_name" id="patient_name" >
                                ...
                                <!-- textarea -->
                                <div class="form-group col-md-12">
                                    <label for="note_for_patient">Note For Patient <span class="text-danger">
                                            *</span></label>
                                    <textarea required class="form-control" style="resize: none;" rows="4"
                                        name="note_for_patient" id="note_for_patient"
                                        placeholder="Note For Patient">{{old('note_for_patient')}}</textarea>
                                </div>
                                <div class="col-md-12">
                                    <input type="checkbox" name="send_note" {{old('send_note')?'checked':''}}
                                        class="minimal" value="1" />&nbsp;Send the note as a text message
                                </div>
