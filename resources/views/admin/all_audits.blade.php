 ...
 <div class="content-wrapper">
        ...
        <div class="dashborad-header">
          ...
          <div class="row">
            ...
            <a href="{{url('admin/audits')}}" class="btn btn-primary"> Add Audits</a>
                        <a href="{{url('admin/archived_all_audits')}}" class="btn btn-primary"> Archived Records</a>
                     ...
                     @foreach($all_audit as $value)
                      ...
                      <tr id="row_{{$value->id}}">
                       <td></td>
                        ...
                        <a href="{{url('admin/edit_audit/'.$value->website_id.'/'.$value->id)}}" title="edit"><i class="fa fa-edit text-primary"></i></a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <br>
                            <form action="/admin/email_audit_report" method="POST">
                              @csrf
                              <div > 
...
<script type="text/javascript">
      ...
      function soft_delete_record(website_id,rowId)
      {
          ...
          {     
              $.ajax({
                  type: "POST",
                  url: "{{url('admin/soft_delete_audit')}}",
