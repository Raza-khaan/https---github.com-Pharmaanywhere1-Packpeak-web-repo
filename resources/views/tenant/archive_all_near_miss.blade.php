    ...
    <div class="reports-breadcrum m-0">
          ...
          <div class="row">
            ...
            <div class="col-md-5 text-right">
              ...
              <a href="{{url('/all_near_miss')}}" class="btn btn-primary">Near Miss Report </a>              
            </div>
          </div>    
                  ...
                  <table id="example1"     class="table">
                    ...
                    @forelse($missedPatients as $missedPatient)
                      ...
                      @endif
                        ...
                        <a href="{{url('near_miss/softunarchive/'.$missedPatient->id)}}" title="soft_delete"  ><i class="fa fa-trash text-success"></i>&nbsp;&nbsp;
...
@section('customjs')
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        $("#lblmainheading").html("Archive  Near Miss");
