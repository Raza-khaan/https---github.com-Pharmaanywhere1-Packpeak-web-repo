...
@section('content')
 ...
 <div class="pharma-add report-add">
            <a href="{{url('/')}}/packed" class="active family">Add New Packed</a>
            <a href="{{url('/')}}/packed_report" class="family">Packed Report</a>
            ...
            @endif
              ...
              <div class="box box-primary">
                ...
                <form role="form" id="addpacked" action="{{url('save_pack')}}" method="post" enctype="multipart/form-data">
...
<nav class="dash-breadcrumb" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Add New Pack</li>
    </ol>
</nav>
                ...
                <div class="row">
                        ...
                        <div class="col-md-6">
                         <div class="patient-information">
                              ...
                              <div class="">
                                <button type="submit" class="btn btn-primary" id="add_checking">{{__('Add Pack')}}</button>
...
$(document).ready(function() {
    ...
    $("#addpacked").on('submit', function(e) {
        ...
        if (confirm('Are you sure you want to save this thing into the database?')) {
          $.ajax({
                ...
                type: "POST",
                url: "{{url('save_pack')}}",
                data: $('#addpacked').serialize() + '&_token=' + '{{ csrf_token() }}',
                beforeSend: function() {
                ...
                success: function(result) {
                    ...
                    window.location.href ="packed_report";
