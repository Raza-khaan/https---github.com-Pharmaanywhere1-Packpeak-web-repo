...
<!-- popper -->
   <script src="{{ URL::asset('admin/bootstrap/js/popper.min.js')}}"></script>
   ...
   <script src="{{ URL::asset('admin/plugins/input-mask/jquery.inputmask.js')}}" type="text/javascript"></script>
    ...
    <script src="{{ URL::asset('admin/bootstrap/js/custom.js')}}"></script>
    <script src="{{ URL::asset('js/bootbox.all.min.js') }}" type="text/javascript"></script>
    <script src="{{ URL::asset('js/bootbox.locales.min.js') }}" type="text/javascript"></script>
    <script src="{{ URL::asset('js/bootbox.min.js') }}" type="text/javascript"></script>
...
$(document).ready(function(){
  $(window).on('load', function() {
            ...
            url:"{{ url('/isverification') }}",
              ...
              success: function (result)
               {  
                ...
                {
                  $("#lblaccountverification").fadeOut();
                }
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/v/bs4/jq-3.3.1/jszip-2.5.0/dt-1.10.25/b-1.7.1/b-colvis-1.7.1/b-html5-1.7.1/b-print-1.7.1/cr-1.5.4/date-1.1.0/fc-3.3.3/fh-3.1.9/kt-2.6.2/r-2.2.9/rg-1.1.3/rr-1.2.8/sc-2.0.4/sb-1.1.0/sp-1.3.0/sl-1.3.3/datatables.min.js"></script>
