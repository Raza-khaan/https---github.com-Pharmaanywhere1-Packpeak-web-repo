...
@section('title') <title>All Packed Report</title>
<style>
                        .dt-buttons button{
                  ...
                  <table id="example1"  data-model='Checkings'   class="table">
                    ...
                    @foreach($checkings as $checking)
                      ...
                      @endif
                        ...
                        @if(request()->get('role_type')=='admin')
                        <td>
                        <a href="{{url('checkings/softpacakarchive/'.$checking->id)}}" title="soft_delete"  ><i class="fa fa-trash text-info"></i>&nbsp;&nbsp;
                          <a href="{{url('packed/delete/'.$checking->id)}}" title="delete"  onclick="return confirm('Are you sure you want to delete this report?');"><i class="fa fa-trash text-danger"></i>&nbsp;&nbsp;
                          <a href="{{url('checkings/packedit/'.$checking->id)}}" title="edit"><i class="fa fa-edit text-success"></i></a>
                        </td>
                        @endif
...
@section('customjs')
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $("#lblmainheading").html("Packed Report");
