...
<html>
  ...
  <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="host-forward" method="post">
          {{ csrf_field() }}
          <div class="form-group">
          <!-- <label>We will setup packnpeaks for you at:</label><br> -->
            www.<input type="text"  name="host_name" id="host_name" autocomplete="host-name" placeholder="company or hostname"/>.packpeak.com.au
          </div>
            <div class="row">
              <div class="col-xs-8">    
