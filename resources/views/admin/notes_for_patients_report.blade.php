 ...
 <div class="content-wrapper">
        ...
        <div class="dashborad-header">
          ...
          <div class="row">
            ...
            <a href="{{url('admin/archived_notes_for_patients_report')}}" class="btn btn-primary"> Archived Records</a>
                        <!-- <a href="{{url('admin/email_note_for_patient_report')}}" class="btn btn-primary" data-toggle="modal" data-target="#emailModal"> Email Report</a> -->
                        <!-- <a href="{{url('admin/sms_tracking_report')}}" class="btn btn-info" > SMS Tracking Report</a> -->
                    ...
                    <tbody>
                     @foreach($all_not_for_patient as $value)
                      <tr id="row_{{$value->id}}">
                        ...
                        <a href="{{url('admin/edit_note_for_patient/'.$value->website_id.'/'.$value->id)}}" title="edit"><i class="fa fa-edit text-primary"></i></a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
...
<script type="text/javascript">
      ...
      function soft_delete_record(website_id,rowId)
      {
          ...
          {     
              ...
              $.ajax({
                  type: "POST",
                  url: "{{url('admin/soft_delete_note_for_patient')}}",
