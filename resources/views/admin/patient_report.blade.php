...
@section('title') <title>Patient Report </title>
<style>
  /* #example1_wrapper {
    display: flex;
    flex-direction: row;
          ...
          @if(Session::has('msg'))
            ...
            <div class="col-md-12">
              <div class="patient-information all-logs-info">
                ...
                <form class="report-form"   action="{{ url('admin/patient_filter_report') }}" method="post"  >
                {{ csrf_field() }}
                  ...
                  <table id="example1" class="table">
                    ...
                    <tbody>
                     ...
                     @php
                      ...
                      <tr id="row_{{$value->id}}">
                        <td></td>
                      <td>{{ucfirst($value->first_name).' '.ucfirst($value->last_name)}}
 <!-- {{$value->dob}} -->
