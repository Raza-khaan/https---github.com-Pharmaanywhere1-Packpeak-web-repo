...
@section('content')
 ...
 <div class="dashborad-header">
        ...
        <div class="user-menu">
            ...
            @endif
              <!-- general form elements -->
                ...
                <form id="form"  role="form" action="{{url('admin/update_packed/'.$get_checking[0]->website_id.'/'.$get_checking[0]->id)}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="reports-breadcrum">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add Packed</li>
                            </ol>
                            </nav>
        ...
        <div class="col-md-6 m-auto">
                    ...
                    <div class="notes">
                        <h3 class="text-center">Update Packed</h3>
...
<label>Location </label>
                            ...
                            @endif
                              ...
                              <div class="">
                                <button style="width:100%" type="submit" class="btn btn-primary">Update Packed</button>
                              </div>
