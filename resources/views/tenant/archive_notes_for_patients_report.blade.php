    ...
    <div class="reports-breadcrum m-0">
          ...
          <div class="row">
            ...
            <div class="col-md-5 text-right">
              <a href="{{url('/notes_for_patients_report')}}" class="btn btn-primary">Patients Notes Report</a>
                  ...
                  <table id="example1"   class="table">
                    ...
                    @if(isset($notes_for_patient->patients->first_name) && $notes_for_patient->patients->first_name!="")
                      ...
                      @endif
                        ...
                        <a href="{{url('notes_for_patients/softunarchive/'.$notes_for_patient->id)}}" title="soft_delete"  ><i class="fa fa-trash text-success"></i>&nbsp;&nbsp;
...
@section('customjs')
 ...
 $(document).ready(function(){
  $("#lblmainheading").html("Archive Note for patient  Report");
