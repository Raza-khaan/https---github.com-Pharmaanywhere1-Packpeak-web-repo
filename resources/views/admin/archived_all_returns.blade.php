...
@section('content')
 ...
 <div class="dashborad-header">
          ...
          <div class="row">
            ...
            <a href="{{url('admin/all_returns')}}" class="btn btn-primary" style="margin-bottom: 2%;"> All Records</a>
    ...
    <script type="text/javascript">
      ...
      function soft_delete_record(website_id,rowId)
      {
          ...
          {     
              $.ajax({
                  type: "POST",
                  url: "{{url('admin/reverse_soft_delete_return')}}",
