...
<div class="col-md-3 ">
  ...
  <a href="{{url('admin/packed')}}" class="btn btn-primary"> Add Packed</a>
                            <a href="{{url('admin/archived_packed_report')}}" class="btn btn-primary"> Archived Records</a>
                ...
                <table id="example1" class="table" style="width:100%">
                     ...
                     @foreach($all_packed as $value)
                      ...
                      <tr id="row_{{$value->id}}">
                        ...
                        <a href="{{url('admin/edit_packed/'.$value->website_id.'/'.$value->id)}}" title="edit"><i class="fa fa-edit text-primary"></i></a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
...
<script type="text/javascript">
      ...
      function soft_delete_record(website_id,rowId)
      {
          ...
          {     
              $.ajax({
                  type: "POST",
                  url: "{{url('admin/soft_delete_packed')}}",
