    ...
    <div class="reports-breadcrum m-0">
          ...
          <div class="row">
            ...
            <div class="col-md-5 text-right">
              ...
              <a href="{{url('/returns')}}" class="btn btn-primary"> Add Return</a>
              <a href="{{url('/archive_all_returns')}}" class="btn btn-primary"> Archived Records</a>              
            </div>
          </div>    
                  ...
                  <table id="example1"  class="table">
                    ...
                    <tbody>
                      ...
                      @endif
                        ...
                        @if(request()->get('role_type')=='admin')
                        <td>
                        <a href="{{url('return/softarchive/'.$return->id)}}" title="soft_delete"  ><i class="fa fa-trash text-info"></i>&nbsp;&nbsp;
...
@section('customjs')
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $("#lblmainheading").html("Return Report");
      });
