    ...
    <div class="reports-breadcrum m-0">
          ...
          <div class="row">
            ...
            <div class="col-md-5 text-right">
              ...
              <a href="{{url('/audits')}}" class="btn btn-primary"> Add Audit</a>
              <a href="{{url('/archive_all_audits')}}" class="btn btn-primary"> Archived Records</a>              
            </div>
          </div>    
                  ...
                  <table id="example1" data-model='Audit' class="table">
                    ...
                    @if(isset($audit->patients->first_name) && $audit->patients->first_name!="")
                      ...
                      @endif
                        ...
                        @if(request()->get('role_type')=='admin')
                        <td>
                        <a href="{{url('audits/softarchive/'.$audit->id)}}" title="soft_delete"  ><i class="fa fa-trash text-info"></i>&nbsp;&nbsp;
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#lblmainheading").html("Audit  Report");
