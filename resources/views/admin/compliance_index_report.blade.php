...
@section('title') <title>Compliance Index Report </title>
<style>
  /* #example1_wrapper {
    display: flex;
    flex-direction: row;
        ...
        <div class="dashborad-header">
          ...
          <div class="row">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Compliance Index Report</li>
              </ol>
            </div>
          ...
          @if(Session::has('msg'))
            ...
            <div class="col-md-12">
              <div class="patient-information all-logs-info">
                ...
                <form class="report-form"   action="{{ url('admin/compliance_index_filter_report') }}" method="post"  >
                {{ csrf_field() }}
                    ...
                    <tbody>
                     ...
                     @php
                      ...
                      <td>
                        ...
                        <td>
                          <span class="badge badge-warning">{{$value->isNeedreview}}</span>  
                        </td>
