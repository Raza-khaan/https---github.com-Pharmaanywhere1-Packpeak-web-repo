            ...
            <div class="side-menu">
                ...
                <div class="accordion">
                    ...
                    <ul>
                        ...
                        <li class="sidenav">
                            <a class="nav-link active"  href="{{url('packboard')}}"><img
                                    src="{{ URL::asset('admin/images/list.png')}}"
                                    alt=""><span>Packs Board</span></a>
                        </li>
                        ...
                        @if($Subscription->form6 || $Subscription->form7 )
                                <li class="sidenav">
                                    <a  href="{{url('/')}}/new_patients_report"><img src="{{ URL::asset('admin/images/disabled.png')}}"
                                ...
                                <li class="sidenav">
                                    <a  href="{{url('/')}}/packed"><img src="{{ URL::asset('admin/images/magic-wand.png')}}"
                                                alt=""><span>Packing</span></a>
</li>
                                ...
                                @if($Subscription->form9 || $Subscription->form10 )
                                <li class="sidenav">
                                    <a href="{{url('/')}}/checkings"><img src="{{ URL::asset('admin/images/magic-wand.png')}}"
                                                alt=""><span>Checkings</span></a>
                                ...
                                <li class="sidenav">
                                    <a href="{{url('/')}}/pickups"><img src="{{ URL::asset('admin/images/ambulance.png')}}"
                                                alt=""><span>Pick Ups</span></a>
                                    <!-- <ul style="display: none;">
                                ...
                                <li class="sidenav ">
                                <a href="{{url('/')}}/returns"><img src="{{ URL::asset('admin/images/reply.png')}}"
                                                alt=""><span>Returns</span></a>
                                    <!-- <ul style="display:none;">
                                ...
                                <li class="sidenav">
                               <a href="{{url('/')}}/audits"><img src="{{ URL::asset('admin/images/editing.png')}}"
                                                alt=""><span>Audits</span></a>
                                    <!-- <ul style="display:none;">
                                ...
                                $Subscription->form14)
                                <li class="sidenav">
                                    <a href="{{url('/')}}/near_miss"><img src="{{ URL::asset('admin/images/price-tag.png')}}"
                                                alt=""><span>Near Miss</span></a>
                                    <!-- <ul style="display:none;">
                                ...
                                <li class="sidenav">
                                <h4><a href="#"><img src="{{ URL::asset('admin/images/cog.png')}}"
                                                alt=""><span>Settings</span></a><i class="fa fa-angle-right"></i></h4>
                                                <ul style="display: none;">
