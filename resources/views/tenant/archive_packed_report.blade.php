    ...
    <div class="reports-breadcrum m-0">
          ...
          <div class="row">
            ...
            <div class="col-md-5 text-right">
              ...
              <a href="{{url('/packed_report')}}" class="btn btn-primary"> Packed Report</a>              
            </div>
          </div>    
                  ...
                  <table id="example1"  data-model='Checkings'   class="table">
                    ...
                    @foreach($checkings as $checking)
                      ...
                      @endif
                        ...
                        @if(request()->get('role_type')=='admin')
                        <td>
                        <a href="{{url('checkings/softpackunarchive/'.$checking->id)}}" title="soft_delete"  ><i class="fa fa-trash text-success"></i>&nbsp;&nbsp;
