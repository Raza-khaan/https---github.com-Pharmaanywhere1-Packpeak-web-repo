...
<div class="row">
  ...
  <div class="col-md-5">
  <a style="float:right" href="{{url('admin/pickups_reports')}}" class="btn btn-primary" style="margin-bottom: 2%;"> All Pickups Report</a>
...
@section('customjs')
    ...
    <script type="text/javascript">
          ...
          {     
              $.ajax({
                  ...
                  success: function(result){
                      ...
                      if(result=='200'){
                        $('#row_'+rowId).remove();
                        $('.alertmessage').html('<span class="alert alert-success">Record Unarchived...</span>');
                      }
                      else{ 
      ...
      function soft_delete_record(website_id,rowId)
      {
        ...
        console.log('Hello');
          if(confirm('Do you want  to soft un archive this?'))
          {     
              $.ajax({
                  type: "POST",
